  ...
  return (
    <div className="p-8 space-y-8 bg-background min-h-screen">
      <section className="space-y-4">
        ...
        <div className="flex items-center p-2 border border-border rounded-lg bg-backgroundSecondary">
        ...
        <p className="text-xs text-textSecondary">The spacer pushes "Right" to the end of the container.</p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p className="text-xs text-textSecondary">Visible background added to spacer for demonstration.</p>
      </section>
