    ...
    <div className="p-8 space-y-8 bg-background min-h-screen">
      <section className="space-y-4">
        ...
        <div className="flex items-center p-2 border border-border rounded-lg bg-background2">
          ...
          <div className="px-3 py-1 bg-neutral-500 text-white rounded-sm">Right</div>
        </div>
      ...
      <section className="space-y-4">
        ...
        <div className="flex flex-col border border-border rounded-lg h-64 p-4">
          <div className="p-2 bg-neutral-100 dark:bg-neutral-800 rounded-sm">Header</div>
          <Spacer orientation="vertical" size={ 20 } />
          <div className="p-2 bg-neutral-100 dark:bg-neutral-800 rounded-sm">Sub-header</div>
