    ...
    >
      { showPulse && (
        ...
        >
          <button
            onClick={ onClick }
            className={ cn(
              'group flex items-center relative gap-2 overflow-hidden border rounded-full px-4 py-2 backdrop-blur-sm transition-all',
              currentStyle.button,
              className,
            ) }
          >
      ...
      { !showPulse && (
        <button
          onClick={ onClick }
          className={ cn(
            'group relative flex gap-2 overflow-hidden border rounded-full px-4 py-2 backdrop-blur-sm transition-all',
            currentStyle.button,
            className,
          ) }
        >
