...
import { SpeakerNode, type SpeakerMapValue, type SpeakerAttributes } from 'tiptap-speaker-node'

// --- Tiptap Node ---
import { ImageUploadNode } from 'tiptap-styles/tiptap-node'
import { HorizontalRule } from 'tiptap-styles/tiptap-node'
...
export const createExtensions = (options: ExtensionsOptions) => {
